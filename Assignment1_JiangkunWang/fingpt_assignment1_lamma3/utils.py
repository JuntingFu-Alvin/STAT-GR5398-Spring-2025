...
lora_module_dict = {
    ...
    "llama3-instruct-local":["q_proj", "v_proj"," o_proj", "gate_proj"],
...
def parse_model_name(name, from_remote=False):
    ...
    elif name == "llama3-instruct-local":
      	 return "/content/drive/MyDrive/fingptpj1/fingpt_assignment1_lamma3/Meta-Llama-3-1-8B-Instruct"
